...
public class Fees_System extends javax.swing.JFrame {
    ...
    private void generateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_generateActionPerformed
        ...
        String a = roll_no.getText();
        int i=Integer.parseInt(a);
        if(i==1){
        area.setText(area.getText() + "\n\nDate  : " + date + "\n\n");
        area.setText(area.getText() + "Student Name         :   SHIVAM KAUSHAL\n\n");
        area.setText(area.getText() + "Father Name           :   MUKESHKAUSHAL\n\n");
        area.setText(area.getText() + "Amount Submitted  :   20000\n\n");
        area.setText(area.getText() + "Roll no                     :   001\n\n");
        area.setText(area.getText() + "Department             :   COMPUTER SCIENCE\n\n");
        area.setText(area.getText() + "Section                    :   A\n\n");
        area.setText(area.getText() + "Batch Time              :   9:00-10:00\n\n");
        area.setText(area.getText() + "Mobile No               :   9999999921\n\n");
        area.setText(area.getText() + "Address                   :   AMBALA CANTT\n\n");
        area.setText(area.getText() + "Gender                    :   Male\n\n");
        area.setText(area.getText() + "Scholarship              :   None\n\n");
        area.setText(area.getText() + "\n\n\n\n                                                                              Signature\n");
        }
        else if(i==2) {
        area.setText(area.getText() + "\n\nDate  : " + date + "\n\n");
        area.setText(area.getText() + "Student Name         :   YASH PANDEY\n\n");
        area.setText(area.getText() + "Father Name           :   PREM PANDEY\n\n");
        area.setText(area.getText() + "Amount Submitted  :   40000\n\n");
        area.setText(area.getText() + "Roll no                     :   002\n\n");
        area.setText(area.getText() + "Department             :   COMPUTER SCIENCE\n\n");
        area.setText(area.getText() + "Section                    :   A\n\n");
        area.setText(area.getText() + "Batch Time              :   9:00-10:00\n\n");
        area.setText(area.getText() + "Mobile No               :   8708269966\n\n");
        area.setText(area.getText() + "Address                   :   AMBALA CANTT\n\n");
        area.setText(area.getText() + "Gender                    :   Male\n\n");
        area.setText(area.getText() + "Scholarship              :   None\n\n");
        area.setText(area.getText() + "\n\n\n\n                                                                              Signature\n");
        ...
        area.setText(area.getText() + "\n\nDate  : " + date + "\n\n");
        area.setText(area.getText() + "Student Name         :   NIHAL SAINI\n\n");
        area.setText(area.getText() + "Father Name           :   SHUSHIL SAINI\n\n");
        area.setText(area.getText() + "Amount Submitted  :   40000\n\n");
        area.setText(area.getText() + "Roll no                     :   003\n\n");
        area.setText(area.getText() + "Department             :   COMPUTER SCIENCE\n\n");
        area.setText(area.getText() + "Section                    :   A\n\n");
        area.setText(area.getText() + "Batch Time              :   9:00-10:00\n\n");
        area.setText(area.getText() + "Mobile No               :   8708269966\n\n");
        ...
        area.setText(area.getText() + "\n\nDate  : " + date + "\n\n");
        area.setText(area.getText() + "Student Name         :   mayank \n\n");
        area.setText(area.getText() + "Father Name           :   raj\n\n");
        area.setText(area.getText() + "Amount Submitted  :   30000\n\n");
        area.setText(area.getText() + "Roll no                     :   004\n\n");
        area.setText(area.getText() + "Department             :   COMPUTER SCIENCE\n\n");
        area.setText(area.getText() + "Section                    :   A\n\n");
        area.setText(area.getText() + "Batch Time              :   9:00-11:00\n\n");
        area.setText(area.getText() + "Mobile No               :   8708269966\n\n");
        area.setText(area.getText() + "Address                   :   AMBALA CANTT\n\n");
        area.setText(area.getText() + "Gender                    :   Male\n\n");
        area.setText(area.getText() + "Scholarship              :   None\n\n");
        ...
        area.setText(area.getText() + "\n\nDate  : " + date + "\n\n");
        area.setText(area.getText() + "Student Name         :   NIKHIL HANS\n\n");
        area.setText(area.getText() + "Father Name           :   SUNIL HANS I\n\n");
        area.setText(area.getText() + "Amount Submitted  :   40000\n\n");
        area.setText(area.getText() + "Roll no                     :   003\n\n");
        area.setText(area.getText() + "Department             :   COMPUTER SCIENCE\n\n");
        area.setText(area.getText() + "Section                    :   A\n\n");
        area.setText(area.getText() + "Batch Time              :   11:00-1:00\n\n");
        area.setText(area.getText() + "Mobile No               :   8708269966\n\n");
        area.setText(area.getText() + "Address                   :   AMBALA CANTT\n\n");
        area.setText(area.getText() + "Gender                    :   Male\n\n");
        area.setText(area.getText() + "Scholarship              :   None\n\n");
        ...
        area.setText(area.getText() + "\n\nDate  : " + date + "\n\n");
        area.setText(area.getText() + "Student Name         :   KRISH \n\n");
        area.setText(area.getText() + "Father Name           :    YASH \n\n");
        area.setText(area.getText() + "Amount Submitted  :   10000\n\n");
        area.setText(area.getText() + "Roll no                     :   006\n\n");
        area.setText(area.getText() + "Department             :   COMPUTER SCIENCE\n\n");
        area.setText(area.getText() + "Section                    :   A\n\n");
        area.setText(area.getText() + "Batch Time              :   9:00-10:00\n\n");
        area.setText(area.getText() + "Mobile No               :   8708269966\n\n");
        ...
        area.setText(area.getText() + "\n\nDate  : " + date + "\n\n");
        area.setText(area.getText() + "Student Name         :   BHAVYA \n\n");
        area.setText(area.getText() + "Father Name           :     \n\n");
        area.setText(area.getText() + "Amount Submitted  :   35000\n\n");
        area.setText(area.getText() + "Roll no                     :   006\n\n");
        area.setText(area.getText() + "Department             :   COMPUTER SCIENCE\n\n");
        area.setText(area.getText() + "Section                    :   A\n\n");
        area.setText(area.getText() + "Batch Time              :   9:00-10:00\n\n");
